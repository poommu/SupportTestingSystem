...
export class AuthService {
  ...
  CreateUser(email, password) : Observable<ResponseAdd>{
    var urlCreate = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCtIRej4tQI0C6kWobobGX7PJrCpgJ6dMg";
  ...
  SendVerificationMail(idToken) {
    var urlValidate= "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyCtIRej4tQI0C6kWobobGX7PJrCpgJ6dMg";
